...
Puedo ver que las distribuciones de ingresos entre varones y entre mujeres de distintas provincias es bastante parecida, excepto por la región de la Patagonia donde los salarios masculinos se concentran alrededor de valores más altos. Además, podemos ver que las mujeres de Cuyo tienen la probabilidad de tener los salarios más bajos  de entre todos los grupos.
