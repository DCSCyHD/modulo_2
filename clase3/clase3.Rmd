...
Por ejemplo, nuestro gráfico con la cantidad de observaciones por región lucía así:
...
-   La variable de interés (en este caso, "Region") se asigna al atributo estético "fill"
