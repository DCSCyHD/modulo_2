...
register_stadiamaps("81834ce1-00c3-4c88-b30f-12f781571218") #Entre las " " deben ingresar su clave API que obtienen al registrarse en Stadia Maps
bbox <- st_bbox(radios)
...
mapa_CABA2 <- get_stadiamap(bbox, zoom = 10)
```
...
```{r message=FALSE, warning=FALSE}
mapa_CABA_toner <- get_stadiamap(bbox, maptype = "stamen_toner_lite", zoom = 15)
