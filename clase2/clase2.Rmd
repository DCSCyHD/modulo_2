...
Entonces nos quedamos con las leyendas (ya no las deshabilitamos con `guides()`), y le podemos pedir a ggplot que el tamaño de los puntos ya no represente los valores de la columna "pobl", si no el resultado de los valores de la columna divididos por un millón. ¿Cómo sería?
